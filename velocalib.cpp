...
//        }
        ...
        if (nodeName == "points_") {
            ...
            while (!item.isNull()) {
                ...
                rotCorrection.push_back(px.firstChildElement("rotCorrection_").text().toDouble() / 180.0 * M_PI);
                vertCorrection.push_back(px.firstChildElement("vertCorrection_").text().toDouble()  / 180.0 * M_PI);
